...
# row which will accept system date
alter table customer add system_date date after payment;
# system current date
update customer set system_date = now();
...
insert into customer values 
('A11' ,'Mukul','kumar' ,'ND', 6125467,'2000-01-15' ,1800.50,now()),
('A12' ,'Vaibhav','Kumar', 'UP' ,5560379,'1999-12-20' ,1900.75,now()), 
('A13' ,'Tushar','Singh', 'HP' ,4560389,'2000-07-25' ,1500.00,now()),
('A14' ,'Saurav', 'kumar', 'UK', 6125401,'2000-02-28' ,1860.00,now()), 
('A15' ,'Arvind' ,'Mathur' ,'NE' ,null ,'1999-02-15',1500.50,now());
